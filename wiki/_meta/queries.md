...
Hand-curated reference. Unlike [[Dashboard]], [[Tags]], [[Glossary]], [[Graph]], and [[Changelog]] — which are auto-generated by `tools/compile/pages/` on every `./kb compile` — this file is user-maintained. Add or edit queries as your exploration needs evolve.
